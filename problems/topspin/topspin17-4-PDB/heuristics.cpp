...
void loadPDB(){
	FILE *f1 = fopen("topspin17-4-abst-12-4_1.pdb","r");
	FILE *f2 = fopen("topspin17-4-abst-12-4_2.pdb","r");
	FILE *f3 = fopen("topspin17-4-abst-12-4_3.pdb","r");

    abs1 = read_abstraction_from_file("topspin17-4-abst-12-4_1.abst");
	map1 = read_state_map(f1);

	abs2 = read_abstraction_from_file("topspin17-4-abst-12-4_2.abst");
	map2 = read_state_map(f2);

	abs3 = read_abstraction_from_file("topspin17-4-abst-12-4_3.abst");
