...
void loadPDB() {
	FILE *f1 = fopen("topspin12-4-abs1.pdb", "r");
	FILE *f2 = fopen("topspin12-4-abs2.pdb", "r");
	FILE *f3 = fopen("topspin12-4-abs3.pdb", "r");

    abs1 = read_abstraction_from_file("topspin12-4-abs1.abst");
	map1 = read_state_map(f1);

	abs2 = read_abstraction_from_file("topspin12-4-abs2.abst");
	map2 = read_state_map(f2);

	abs3 = read_abstraction_from_file("topspin12-4-abs3.abst");
